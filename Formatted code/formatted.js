...
function showProfileTab(tabId) {
  ...
  document.querySelector(`.profile-tabs button[onclick*="${tabId}"]`).classList.add('active');
  document.getElementById(`${tabId}-content`).classList.add('active');
}

// Ensure the education tab is active by default on page load
document.addEventListener('DOMContentLoaded', () => {
  showProfileTab('education');
});

// Assuming AOS.init() is already called in your existing script.
// If not, ensure it's called after these elements are in the DOM.
AOS.init();